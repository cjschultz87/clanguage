	...
	{		
		...
		if (fCount == i)
		{
				if ((i * blockVal) < fileSize0)
				{
					...
					WaitForSingleObject(tango_10,1);
		...
		if (fCount == i)
		{
				if ((i * blockVal) < fileSize0)
				{
					...
					WaitForSingleObject(tango_11,1);
		...
		if (fCount == i)
		{
				if ((i * blockVal) < fileSize0)
				{
					...
					WaitForSingleObject(tango_12,1);
